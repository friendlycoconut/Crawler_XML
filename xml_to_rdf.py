...
class Elements:
    def __init__(self, version, element):
...
class Element:
    ...
    def add_to_graph(self, graph):
        ...
        this = FP[conf_name]
        graph.add((this, RDF['type'], FPONT['Element']))
        graph.add((this, RDFS.label, Literal(self.title)))
        graph.add((this, FPONT.hasPrice, Literal(self.price)))
        graph.add((this, FPONT.hasLocation, Literal(self.location)))
        graph.add((this, FPONT.hasEngine, Literal(self.engine)))
